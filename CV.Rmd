...
tribble(
  ...
  "Conservation Intern", "Osa Conservation", "Costa Rica", "6/20 - Present", "Conducted spatial analysis to support Osa Conservation’s work and provide farmers with the necessary information to implement sustainable farming practices in a manner that is beneficial to them and the local wildlife.",
  ...
  "Outdoor Education Instructor", "Keystone Science School", "Keystone, Colorado", "Created place-based environmental science curriculum for summer programs. Led groups of 13 students aged 7 to 17 on back country camping and backpacking trips throughout Colorado.",
